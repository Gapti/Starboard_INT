...
public class UICursorWithLabel : MonoBehaviour
{
	static public UICursorWithLabel instance;
	...
	void Start ()
	{
		...
		StackLabel = GetComponentInChildren<UILabel>();
	...
	static public void Set (UIAtlas atlas, string sprite)
	{
		...
		{
			instance.StackLabel.enabled = false;
	...
	static public void Set (UIAtlas atlas, string sprite, string stackAmount)
	{
		if (instance != null && instance.mSprite)
		{
			instance.StackLabel.enabled = true;
			instance.StackLabel.text = stackAmount;
			instance.mSprite.atlas = atlas;
			instance.mSprite.spriteName = sprite;
			instance.Update();
		}
